...
function searchPrompt(avoid,mode,seconds){
  ...
  return 'Investiga videos públicos para crear contenido original de LEGADO DE HIERRO en español. Hoy: '+new Date().toISOString().slice(0,10)+'. '
    ...
    +'Devuelve solo JSON válido, sin markdown, con esta forma: {"ideas":[{"concept":"Tema original concreto, máximo 18 palabras","t":"mentalidad","h":"historia","family":"relato","audience":"disciplina","format":"Historia con giro","opening":"Cómo abrir ESTA idea y qué curiosidad despertar","beats":["Primer avance específico de ESTA idea","Segundo avance y su coste","Tercer avance distinto"],"payoff":"Qué respuesta observable entrega ESTA idea al final","videoUrl":"URL canónica del video público de YouTube encontrado, o cadena vacía si no hay uno"}]}. '

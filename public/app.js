...
function buildSP(){
  if(sMode==='impacto')return `Eres el Guionista Principal del canal LEGADO DE HIERRO en Facebook Reels. Voz: directa, cruda, sin motivación vacía. Oraciones cortas. Verdad incómoda sobre dinero y libertad.\n\nMODO IMPACTO — 25 a 35 segundos: una sola verdad demoledora. Máximo 55 palabras en el BLOQUE A. Golpe desde la primera palabra, sin reflexión previa.\n\nAPERTURAS QUE GOLPEAN (varía cada vez): "Te han programado para creer que...", "Lo que llamas seguridad es la jaula más cara que existe.", "Quemas tus mejores años en la comodidad de la jaula.", "Tu silencio frente al dinero te está costando la libertad."\n\nPROHIBIDO: "la gente piensa", "el noventa por ciento", motivación vacía, más de 55 palabras, preguntas largas de apertura.\nCIERRE estoico sin esperanza falsa. Todos los guiones terminan con: Legado de Hierro.\nFORMATO: sin markdown, sin **, sin ##. Solo texto plano.\nREGLA ABSOLUTA BLOQUE A: SOLO texto hablado. SIN corchetes, etiquetas, hashtags, ni prompts.\n\nGENERA EXACTAMENTE ESTOS 3 BLOQUES:\n\nBLOQUE A\n[Solo texto hablado en español. Máximo 55 palabras. Termina con: Legado de Hierro.]\n\nBLOQUE C\nREGLA: 2 prompts solamente. PROMPT 1: escena del hombre en su situación actual (camiseta simple, taller humilde, escritorio básico) o close-up de objeto simbólico (reloj, pantalla con transferencia, billetes). PROMPT 2: escena Alpha (hombre traje oscuro caminando hacia cámara en puente de vidrio entre rascacielos, o balcón de rascacielos al atardecer, o pasillo corporativo nocturno). Especifica ángulo, luz, postura.\nPROMPT 1: [momento 1]\nPROMPT 2: [momento 2]\n\nBLOQUE F\n[Traducción como angloparlante nativo. Solo texto hablado en inglés. Máximo 55 palabras. Termina con: Iron Legacy.]`;
...
async function generate(){
  ...
  var identidad='IDENTIDAD FIJA DEL PERSONAJE EN PROMPTS: A handsome 35-year-old man, short black hair slicked back, short dark beard, strong jawline, intense dark brown eyes, serious expression never smiling, black three-piece suit, dark tie, white pocket square, luxury watch on left wrist. American 2D comic book illustration, clean ink lines, cel-shading, NOT photorealistic. 9:16 vertical portrait. No text in image. NO robots, NO futurism, NO sci-fi, NO broken chains, NO magic effects, NO fantasy. Real business and finance world only. NO rain near character -- use city lights and shadows for dramatic atmosphere. GAZE DIRECTION: character looks at whatever the action requires. Does NOT look at camera unless prompt explicitly says so. No modeling pose by default. ESCENAS VIRALES (usa estas en los prompts): hombre en camiseta simple en taller humilde con laptop vieja y billetes pequeños (el espectador se reconoce); pantallas rojas con FALLING/GLOBAL DOWNTURN; close-up reloj de lujo con dedo en la esfera; teclado con pantalla ENVIO CAPITAL GLOBAL CONFIRMADO; hombre traje oscuro caminando hacia cámara por puente de vidrio entre rascacielos al amanecer; hombre de espaldas en pasillo corporativo nocturno; hombre en balcón de rascacielos al atardecer.';

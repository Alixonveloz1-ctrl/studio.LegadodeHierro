...
function buildSP(){
  if(sMode==='impacto')return `Eres el Guionista Principal del canal LEGADO DE HIERRO. Modo IMPACTO: una sola verdad demoledora en 25-35 segundos.\n\nVOZ: segunda persona directa, cruda, sin motivación vacía. Golpe corto y seco desde la primera palabra. Máximo 55 palabras en el guion hablado.\n\nAPERTURAS QUE GOLPEAN (varía, nunca repitas):\n- "Te han programado para creer que..."\n- "Lo que llamas seguridad es la jaula más cara que existe."\n- "Quemas tus mejores años en la comodidad de la jaula."\n- "Tu silencio frente al dinero te está costando la libertad."\n\nPROHIBIDO: "la gente piensa", "el noventa por ciento", motivación vacía, más de 55 palabras.\nCIERRE estoico sin esperanza falsa. Termina con: Legado de Hierro.\n\nGENERA EXACTAMENTE ESTOS 3 BLOQUES:\n\nBLOQUE A\n[Guion hablado en español. Máximo 55 palabras. Termina con: Legado de Hierro.]\n\nBLOQUE C\nPROMPT 1: [escena de impacto — hombre en situación que el espectador reconoce como su vida actual, o close-up de objeto simbólico. Especifica ángulo, luz, postura.]\nPROMPT 2: [escena de poder — hombre Alpha en rascacielos/puente de vidrio/balcón al amanecer, o close-up de reloj de lujo/transferencia confirmada. Especifica ángulo, luz, postura.]\n\nBLOQUE F\n[Solo texto hablado en inglés. Máximo 55 palabras. Termina con: Iron Legacy.]`;
...
async function generate(){
  ...
  var identidad='IDENTIDAD FIJA DEL PERSONAJE EN PROMPTS: A handsome 35-year-old Hispanic man, short black hair slicked back, short dark beard, strong jawline, intense dark brown eyes, serious expression never smiling, black three-piece suit, dark tie, white pocket square, luxury watch on left wrist. American 2D comic book illustration, clean ink lines, cel-shading, NOT photorealistic. 9:16 vertical portrait. No text in image. NO robots, NO futurism, NO sci-fi, NO broken chains, NO magic effects, NO fantasy. Real business and finance world only. NO rain near the character -- for dramatic atmosphere use city lights and shadows only. GAZE DIRECTION (mandatory): the character looks at whatever the action requires. Does NOT look at camera unless prompt explicitly says so. No modeling pose by default. VIRAL SCENE ARCHETYPES -- use these instead of generic office scenes: TRABAJADOR: plain dark green t-shirt, humble workshop or basic desk, old laptop, coins or small bills on worn wooden table -- viewer recognizes himself here. CRISIS: multiple screens red charts FALLING/GLOBAL DOWNTURN text; OR man holding document stamped CERRADO facing rain-streaked window city night. OBJETO SIMBOLICO: extreme close-up luxury watch wrist finger tapping crystal; OR keyboard screen reading ENVIO CAPITAL GLOBAL CONFIRMADO in green; OR stacked banded bills coins beside laptop. HERRAMIENTA: holographic panel IA MKT/VENTAS neural brain icon; OR watchmaker precision magnifying lens fine tools; OR green-ascending multi-monitor trading terminal. ALPHA: dark three-piece suit walking toward camera glass bridge between skyscrapers at dawn; OR back-view walking glass corporate hallway city night; OR rooftop balcony golden hour overlooking city. ARCO OBLIGATORIO: prompts 1-2 use TRABAJADOR or CRISIS (viewer recognizes himself), prompts 3-4 use HERRAMIENTA or OBJETO, prompt 5 always ALPHA (the destination).';

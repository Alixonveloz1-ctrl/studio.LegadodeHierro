...
1. ADQUISICIÓN QUE ESCALA: los clientes llegan por un sistema que crece solo (una audiencia, contenido que se difunde, un producto que se distribuye), NUNCA persiguiéndolos uno por uno. Si el negocio te obliga a buscar clientes todos los días, es rebusque disfrazado de emprendimiento: NO va. Esto aplica DESDE EL PRIMER CLIENTE: prohibido enseñar a tocar puertas, ir local por local o visitar los comercios de tu zona; los primeros clientes también llegan por contenido, audiencia o distribución.
